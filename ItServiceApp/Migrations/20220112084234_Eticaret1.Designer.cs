...
namespace ItServiceApp.Migrations
{
    ...
    [Migration("20220112084234_Eticaret1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItServiceApp.Entity.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ItServiceApp.Entity.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ItServiceApp.Entity.State", b =>
                {
                    b.HasOne("ItServiceApp.Entity.City", "City")
                        .WithMany("States")
            ...
            modelBuilder.Entity("ItServiceApp.Models.Entities.Address", b =>
                {
                    b.HasOne("ItServiceApp.Entity.State", "State")
                        .WithMany()
